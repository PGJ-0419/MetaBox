...
class CEC2013LSGO_Problem(Basic_Problem):
    def __init__(self):
        ...
        # 设置默认的数据类型
        self.data_dir = "MetaBox/src/problem/datafiles/LSGO/classical/cec2013lsgo" # 数据文件夹
